...
function TodoRegisterComponents({setResult}) {
    ...
    return (
        <>
            ...
            <Box sx={{p:1}}>
                <TextField variant="outlined" fullWidth name={'title'} label={'title'} onChange={(e) => changeTodo(e)}></TextField>
            </Box>
            <Box sx={{p:1}}>
                <TextField variant="outlined" fullWidth name="writer" label={'writer'} onChange={(e) => changeTodo(e)}></TextField>
            </Box>
