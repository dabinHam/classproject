...
public class Calculator {
	...
	// 5. 실수 반지름 하나를 매개변수의 인자로 전달받아 / 원의 둘레를 구해 / 반환하는 메소드를 반환하는 메소드를 정의
	// 원의 둘레 : 2 x π x r , π :3.14 , r -> 반지름의 실 수
	public static double circum(double r) {
		// 2 x π x r
		return 2 * 3.14 * r;
	}

	// 6. 실수 반지름 하나를 매개변수의 인자로 전달받아 / 원의 넓이를 구해 / 반환하는 메소드를 반환하는 메소드를 정의
	// 월의 넓이 : π x r x r
