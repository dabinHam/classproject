...
public class SmartPhone3 extends Phone{
	...
	SmartPhone3(String phoneNumber, String model){ 
		super(phoneNumber); //상위클래스 호출
		this.model = model;
	}
	
	// 오버라이딩
	// 상위 클래스에서 정의한 메소드를 재 정의
	// 선언부는 동일하게 처리하고 처리블록 내부의 코드만 재정의
	...
	public static void main(String[] args) {
		...
		Phone phone2 = new SmartPhone2("010-1234-1234","android");
		Phone phone3 = new SmartPhone();
		// 	조상 타입의 참조변수 선언은 조상타입의 멤버만 사용하겠다를 정의한것!
		
		System.out.println(phone.phoneNumber);
		phone.call();
		//System.out.println(phone.mode1);
		//phone.playMusic();
